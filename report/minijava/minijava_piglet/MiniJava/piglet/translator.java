...
import MiniJava.typecheck.symboltable.Method;
import MiniJava.typecheck.symboltable.Root;
import MiniJava.typecheck.symboltable._Class;
import MiniJava.typecheck.visitor.construct_symboltable;
import MiniJava.typecheck.type_check;
...
//		symbol_table_root.print(1);
		...
		tree_root.accept(new translate_visitor<>(), symbol_table_root);
		writer.close();
	}
	...
	public static void main(String[] args){
		try {
			generate_piglet(new FileInputStream("./benchmark/test.java"));
